...
vim.api.nvim_set_keymap("n", "<C-n>", "b", { noremap = true, silent = true }) -- move cursor to left
vim.api.nvim_set_keymap("i", "<C-n>", "<C-o>b", { noremap = true, silent = true }) -- move cursor to left

vim.api.nvim_set_keymap("n", "<C-m>", "w", { noremap = true, silent = true })-- move cursor to right
vim.api.nvim_set_keymap("i", "<C-m>", "<C-o>w", { noremap = true, silent = true }) -- move cursor to right
...
keymap.set("n", "<leader>ct", ":BufferClose<CR>") -- close current tab
...
keymap.set("n", "<leader>eg", ":Neotree float git_status git_base=main<CR>")
...
keymap.set("n", "<leader>tt", ":Themery<CR>", { noremap = true, silent = true })
